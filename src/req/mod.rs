...
impl HttpRequest {
    ...
    // #[cfg(feature = "with-wynd")]
    // pub fn to_hyper_request(&self) -> Result<Request<Bytes>, Box<dyn std::error::Error>> {
    ...
    //             hyper::body::Bytes::from(serde_json::to_string(json)?)
    //         }
    ...
    //             hyper::body::Bytes::from(text.as_bytes().to_vec())
    //         }
    ...
    //             );
    //             hyper::body::Bytes::from(form.to_string().clone())
    //         }
    ...
    //             bytes.clone()
    //         }
    //         RequestBodyContent::EMPTY => Bytes::new(),
    //     };
