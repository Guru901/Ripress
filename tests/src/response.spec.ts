...
test.describe("Response Tests", () => {
    ...
    test("Set cookie with options", async ({request}) => {
        ...
        const cookies = response.headers()["set-cookie"];
        expect(cookies).toBeDefined();
        expect(cookies![0]).toMatch(/secure-cookie=value.*HttpOnly.*Secure.*SameSite=Strict/);
    });
    //
    // test("Clear cookie", async ({request}) => {
    //     const response = await request.get("/clear-cookie-test");
    //
    //     expect(response.status()).toBe(200);
    //
    //     const cookies = response.headers()["set-cookie"];
    //     expect(cookies).toBeDefined();
    //     expect(cookies![0]).toMatch(/cleared-cookie=.*expires=.*Thu, 01 Jan 1970/);
    // });
    //
    ...
    //     const response = await request.get("/content-type-test");
    //
    //     expect(response.status()).toBe(200);
    //
    ...
    // });
    //
    // test("JSON response", async ({request}) => {
    //     const response = await request.get("/json-response-test");
    //
    //     expect(response.status()).toBe(200);
    ...
    //     const response = await request.get("/text-response-test");
    //
    //     expect(response.status()).toBe(200);
    ...
    // });
    //
    // test("HTML response", async ({request}) => {
    //     const response = await request.get("/html-response-test");
    //
    //     expect(response.status()).toBe(200);
    ...
    // });
    //
    // test("Status code 404", async ({request}) => {
    //     const response = await request.get("/not-found-test");
    //
    ...
    // });
    //
    // test("Status code 500", async ({request}) => {
    //     const response = await request.get("/server-error-test");
    //
